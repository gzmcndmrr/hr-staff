          ...
          <div class="flex items-center space-x-2 justify-center w-full mt-8">
            <nav class="isolate inline-flex -space-x-px rounded-md" aria-label="Pagination">
              ...
              <button
                @click=${() => this.goToPage(this.currentPage + 1)}
                ?disabled=${this.currentPage === this.totalPages}
                class="relative inline-flex items-center rounded-r-md px-2 py-2 text-orange-500 ring-white hover:bg-orange-50 focus:z-20 focus:outline-offset-0 disabled:opacity-50 disabled:cursor-not-allowed"
              >
